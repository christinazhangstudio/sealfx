...
export default function LoginCtaBanner({
    ...
    return (
        <div className="mb-6 p-4 sm:p-6 bg-gradient-to-r from-primary/10 to-primary/5 border border-primary/40 rounded-lg">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                <div className="flex-1">
                    <h3 className="glass-caps text-lg font-semibold text-primary mb-1">
                        {title}
                    </h3>
